...
一个**专业级调研报告生成工具**，10 分钟生成对标券商/研究机构标准的深度报告。
...
```bash
# 中文调研
/research 中国新能源汽车市场 --mode standard

# 英文调研
/research AI cloud computing market --mode deep

# 技术选型
/research Vue 3 vs React 性能对比 --mode quick
```
